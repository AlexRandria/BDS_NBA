...
def run():
    ...
    with tab3:
        ...
        st.markdown(
            """
            Après avoir obtenu ma licence lors de ma reconversion en tant que Concepteur Développeur d'applications, j'ai fait ma première expérience de 2 ans dans une entreprise de Data.
